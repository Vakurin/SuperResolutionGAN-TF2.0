...
### SRGAN has three neural networks, a generator, a discriminator, and a pre-trained VGG19 network 
keras = tf.keras
# For Debuging
...
def model_vgg19(output_layer = 5):
    ...
    """
        Используем для извлечения features map из настоящих и ган изображений
    """
